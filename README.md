...
![Nova Calendar - screen 1](https://paweldymek.com/projects/nova-calendar-tool/screen_1.png)
![Nova Calendar - screen 2](https://paweldymek.com/projects/nova-calendar-tool/screen_2.png)
![Nova Calendar - screen 3](https://paweldymek.com/projects/nova-calendar-tool/screen_3.png)
...
```
composer require asciisd/nova-calendar
```

Publish the migration:
```
php artisan vendor:publish --provider='Asciisd\NovaCalendar\ToolServiceProvider' --tag="migrations"
```
...
```
php artisan vendor:publish --provider='Asciisd\NovaCalendar\ToolServiceProvider' --tag="config"
```
...
public function tools()
{
    return [
        // ...
        new \Asciisd\NovaCalendar\NovaCalendar,
    ];
}
```
...
* [czemu/nova-calendar-tool](https://github.com/czemu/nova-calendar-tool)
