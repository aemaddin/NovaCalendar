...
Nova.booting(function (Vue, router, store) {
  router.addRoutes([{
    name: 'nova-calendar',
    path: '/nova-calendar',
    component: _components_Tool__WEBPACK_IMPORTED_MODULE_0__["default"]
  }]);
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Nova Calendar")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "\n                /nova-components/NovaCalendar/resources/js/components/Tool.vue\n            "
                )
              ]
            )
          ])
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/tool"], () => (__webpack_require__("./resources/js/tool.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/tool"], () => (__webpack_require__("./resources/sass/tool.sass")))
